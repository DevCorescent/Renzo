...
export function AppShell({
  ...
  return (
    <div id={THEME_ROOT_ID} className="sa-dash flex min-h-screen bg-white text-gray-900">
      ...
      <aside
        className={cn(
          "fixed inset-y-0 left-0 z-50 flex w-56 flex-col border-r border-gray-200 bg-white transition-transform dark:border-[var(--sa-border)] dark:bg-[var(--sa-sidebar)] lg:sticky lg:top-0 lg:z-auto lg:h-screen lg:translate-x-0",
