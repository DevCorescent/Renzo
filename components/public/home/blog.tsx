...
export function Blog() {
  ...
  return (
    <section className="relative overflow-hidden bg-[#0A0B0D] py-16 sm:py-20">
      {/* Ambient silver glow — matches Hero/Experience */}
      <div
        aria-hidden
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <MotionReveal className="grid gap-8 lg:grid-cols-2 lg:items-end">
          <div className="min-w-0">
            ...
            <h2 className="group max-w-xl font-heading text-2xl font-black leading-tight tracking-tight text-white sm:text-3xl md:text-4xl">
              Stories, Tips &{" "}
              <motion.span
