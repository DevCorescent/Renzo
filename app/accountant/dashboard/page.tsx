...
export default async function AccountantDashboardPage() {
  ...
  const glance = [
    ...
    { label: "Outstanding", value: inr(outstanding), icon: Receipt, tone: "text-gray-500" },
  ...
  const banner = ok
    ...
    : { text: `${inr(outstanding)} outstanding`, wrap: "bg-gray-100/60 ring-gray-200 dark:bg-white/10 dark:ring-white/20", txt: "text-gray-700 dark:text-gray-300", dot: "bg-gray-600", ping: "bg-gray-500" };
  ...
  return (
    <div id={THEME_ROOT_ID} suppressHydrationWarning className="sa-dash -m-6 min-h-[calc(100vh-3.5rem)] bg-slate-50 p-4 transition-colors duration-300 sm:p-6">
      ...
      <div className="mx-auto max-w-350 space-y-6">
        <FadeIn>
          <DashboardHeader role="accountant" userName={userName} greeting={greeting} dateLabel={dateLabel} notifications={[]} hideControls />
        </FadeIn>
        ...
        <Stagger className="grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-4">
          ...
          <StaggerItem><StatCard label="Outstanding" value={outstanding} icon="invoice" accent="neutral" format="inr" hint="unpaid balance" /></StaggerItem>
