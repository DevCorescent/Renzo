...
export default async function WorkerDashboardPage() {
  ...
  const shift = onShift
    ...
    : shiftEnded
      ...
      : { text: "Not clocked in yet", wrap: "bg-gray-100/60 ring-gray-200 dark:bg-white/10 dark:ring-white/20", txt: "text-gray-700 dark:text-white", dot: "bg-gray-400", ping: "bg-gray-300" };
  ...
  const glance = [
    ...
    { label: "Bookings today", value: String(todayCount), icon: CalendarDays, tone: "text-gray-400" },
